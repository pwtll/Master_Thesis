...
if __name__ == "__main__":
    video_file = "../data/vids/angle_jitter_test_2.mp4" ##"../data/triangle_jitter/triangle_jitter_raw_frame_4.avi"  #0 # "../data/vids/angle_jitter_test.mp4"  # VIPL_motion_scenario_p100_v6_source2.avi"  # angle_jitter_test.mp4" # 0
